...
import Magento_Testcases.Magento_BaseClass;
...
public class Reporting implements ITestListener{
	...
	public void onStart(ITestContext context) {
		...
		reporter=new ExtentSparkReporter("E:\\FrameWorks\\Magento\\Reports\\newone.html");
		
		//provide the basic information about the document
		
		reporter.config().setDocumentTitle("Luma Automation Doc");
	...
	public void onTestFailure(ITestResult tr) {
		...
		try {
			String imgPath=new Magento_BaseClass().captureScreen(tr.getName());
